...
import * as service from './cobradores.service';
import type { Actor } from '../usuarios/usuarios.service';
import type { ListCobradoresQuery } from './cobradores.schema';
...
export const list = asyncHandler(async (req: Request, res: Response) => {
  const query = req.query as unknown as ListCobradoresQuery;
